...
resolved_authors_df = spark.sql('SELECT rev_id, rev_date, rev_author, author_id, author_name, FROM revision r LEFT OUTER JOIN author a ON r.rev_author = a.author_id')
