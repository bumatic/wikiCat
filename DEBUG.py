...
resolved_authors_df = spark.sql('SELECT r.rev_id, r.rev_date, r.rev_author as rev_author_id, a.author_name as rev_author_name, a.author_id as author_author_id'
